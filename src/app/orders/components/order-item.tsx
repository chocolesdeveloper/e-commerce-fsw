    ...
    <Card className="px-5">
      <Accordion type="single" className="w-full" collapsible>
        <AccordionItem value={order.id}>
          <AccordionTrigger>
            <div className="flex w-full flex-col justify-between gap-1 text-left lg:flex-row">
              <h2 className="font-bold uppercase">
                Pedido com {order.orderProducts.length} produto(s)
              </h2>
              <p className="text-xs opacity-70 lg:hidden">
                Feito em {format(order.createdAt, "d/MM/y 'ás' HH:mm ")}
              </p>
              <div className="font-bold max-lg:hidden">
                <p>Status</p>
          ...
          <Separator className="sm:max-lg:hidden" />
          <AccordionContent>
